import '../css/Cancel_info.css';

export default function CancelInfo() {
    return(
        <div className="wrap">
            <div className="cancel_info_wrap">
                <div className="cancel_info_title">
                    <h3>예매/취소안내</h3>
                </div>
                <div className="cancel_info_content">
                    <div className="cancel_info_content_title">
                        <h4>티켓 수령안내</h4>
                    </div>
                    <div className="cancel_info_content_desc">
                        <ol className='cancel_info_content_ol'>
                            <li className='cancel_info_content_li'>
                                <span className='cancel_info_title'>1) 일반배송</span>
                                <div>
                                    <span>
                            ...
                            <li className='cancel_info_content_li'>
                                <span className='cancel_info_title'>2) 현장수령</span>
                                <div>
                                    <span>
                        ...
                        <ol className='cancel_info_content_ol'>
                            ...
                            <li className='cancel_info_content_li'>
                                <div>
                                    ...
                                    <table className='cancel_info_content_table' border='1'>
                                        <thead>
                                            <tr>
                                                <th className='cancel_info_content_th'>관람일 구분</th>
                                                <th className='cancel_info_content_th'>취소가능시간</th>
                                            </tr>
                                        </thead>
                                            <tr>
                                                <td className='cancel_info_content_td'>일반</td>
                                                <td className='cancel_info_content_td'>관람일 1일전 17:00시까지</td>
                                            </tr>
                                            <tr>
                                                <td className='cancel_info_content_td'>​관람일이 연휴기간이거나 연휴 다음날인 경우​</td>
                                                <td className='cancel_info_content_td'>연휴 시작일 1일전 17:00시까지<br/>
